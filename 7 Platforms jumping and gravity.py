...
# Tkinter was used in the book

# I think this version in Python 3 and Turtle may be a bit easier
# (But not as elegant)
# J Joubert 27 Dec 2019
# I initially made the jump very complicated and decided to rewrite the code
...
class Player(turtle.Turtle):
    ...
    def jump_up(self):
        if self.dy == 0: # Only jump from flat surface on platform/ground
            self.dy = 6
            self.gravity = 0.2
        else:
